...
export function Sidebar() {
  return (
    <aside className="w-64 bg-secondary-dark min-h-screen p-4 flex flex-col">
            ...
            className={({ isActive }) =>
              `flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors ${
                isActive
                  ...
                  : 'text-grey-400 hover:bg-secondary hover:text-white'
              }`
            }
          >
      ...
      <div className="pt-4 border-t border-grey-700">
        <div className="flex items-center gap-3 px-3 py-2">
          ...
          <div>
            ...
            <p className="text-xs text-grey-400">user@example.com</p>
          </div>
        </div>
      </div>
    </aside>
